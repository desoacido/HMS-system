...
// ✅ QR URL GAMIT ANG API — hindi kailangan ng local file
$base_url = "https://hms-system-1-l6jn.onrender.com";
$qr_data  = $base_url . "/patientprofile.php?id=" . $p['id'];
...
<div class="profile-grid">
        ...
        <div class="info-row">
            ...
            <span class="value">
                <span class="badge <?= $visitCount <= 1 ? 'badge-new' : 'badge-returning' ?>">
                    <?= $visitCount <= 1 ? '🟢 NEW PATIENT' : '🔵 RETURNING' ?>
                </span>
            </span>
        </div>
    ...
    <!-- ✅ QR CODE CARD — gumagamit ng API URL -->
    <div class="card qr-card">
        <h3>🔲 QR Code</h3>
        <img src="<?= $qr_url ?>" class="qr-img"
             title="Click to enlarge" onclick="openQR()">
...
<div class="modal-bg" id="qrModal">
    <div class="modal">
        ...
        <div class="modal-btns">
            ...
            <a class="btn-sm btn-sm-blue" href="<?= $qr_url ?>" download="qr_patient_<?= $p['id'] ?>.png">⬇️ Download</a>
